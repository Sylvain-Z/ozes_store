...
function ProductUpdatePicSecond (){
    ...
    useEffect(() => {
        async function getData() {
            try {
                const second_pics = await fetch("/api/v1/products/secondary-pictures/"+ params.id);
    ...
    return (
        <>
            <section className="form_section">
                ...
                <h3 className="form_title read">Images Secondaires</h3>
...
export default ProductUpdatePicSecond;