...
function UpdateProfil() {
    ...
    useEffect(() => {
        ...
        async function handleSubmit(e) {
            e.preventDefault();
            const res = await fetch(`/api/v1/employees/update-employee/`+ params.id, {
                method: "post",
        ...
        {!employees ? (
                  ...
                  <section className="form_section">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Link to={`/employes/gestion-comptes/${employees[0].id}`} className="button_retour_rouge"><p ><FontAwesomeIcon icon={faDeleteLeft} className="fontawesomeRed " /></p></Link>
